import { Column } from './../models/search';
import { Injectable } from '@angular/core';

@Injectable()
export class CatalogosMC {
    ...
    public initRubros(): any {
        let rubros: any = [
            ...
            { active: false, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: 115, idRubro: 7, textoMenu: 'Solicitud De Apertura', icon: 'solicitud-apertura.png', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' },
            { active: false, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: 186, idRubro: 8, textoMenu: 'Carátula De Depósito', icon: 'caratula-nomina.png', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' },
            { active: false, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: 709, idRubro: 9, textoMenu: 'Aviso Privacidad', icon: 'aviso-privacidad.png', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' },
            { active: false, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: 16, idRubro: 10, textoMenu: 'Consulta a Buró', icon: 'buro.png', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' },
            { active: false, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: 5, idRubro: 11, textoMenu: 'Contrato Firmado', icon: 'contrato-firmado.jpg', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' },
            ...
            { active: false, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: 969, idRubro: 13, textoMenu: 'Formato FATCA', icon: 'credito.png', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' },
            { active: false, hidden: true, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: 601, idRubro: 14, textoMenu: 'Anexo de Comisiones', icon: 'credito.png', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' }
        ];
        return rubros;
    }
    ...
    public getColumNameBandeja(): Array<Column> {
        return [
            new Column("folio", "FOLIO"),
            new Column("empresa", "EMPRESA"),
            new Column("cliente", "CLIENTE"),
            new Column("rfc", "RFC"),
            new Column("tipo_producto", "PRODUCTO"),
            new Column("fecha_recepcion", "FECHA RECEPCIÓN"),
            new Column("revision", "REVISIÓN"),
            new Column("nombreBloqueo", "REVISOR"),
            new Column("imagen", "")
        ];
    }

    public getColumNameBandejaAsesor(): Array<Column> {
        return [
            new Column("folio", "FOLIO"),
            new Column("empresa", "EMPRESA"),
            new Column("cliente", "CLIENTE"),
    ...
    public getRubrosDocumentos(): any {
        let rubros: any = [
            { active: true, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: "menu", idRubro: 106, textoMenu: 'Documentos', icon: 'documentos.png', claseFondo: 'verde-04-active', claseico: 'verde-04-ico', claseActive: 'verde-04-active' },
            ...
            { active: false, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: "8-16", idRubro: 10, textoMenu: 'Consulta A Buro', icon: 'buro.png', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' },
            { active: false, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: "8-6", idRubro: 11, textoMenu: 'Contrato Firmado', icon: 'aviso-privacidad.png', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' },
            ...
            { active: false, hidden: false, status: 'blank.gif', idRechazo: null, comentario: null, idStatusRevision: null, idDocumento: "8-30", idRubro: 14, textoMenu: 'Anexo De Comisiones', icon: 'credito.png', claseFondo: 'verde-04', claseico: 'verde-04-ico', claseActive: 'verde-04-active' }
        ];
        return rubros;
    }
}