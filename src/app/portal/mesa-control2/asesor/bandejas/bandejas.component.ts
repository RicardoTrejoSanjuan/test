...
import { BandejaController } from './../../captacion/bandejas/bandejasController';
...
export class AsesorBandejas extends Pagination {
    ...
    constructor(private router: Router, private notifications?: Notifications, private controller?: BandejaController) {
        super();

        this.tabs = this.currentlytab.getTabsAsesor();
        this.columns = this.controller.getColumnsTableAsesor();
        this.currentlytab = this.tabs.find(tab => tab.id == 5);
        ...
        if (_lastRequest !== null) {
            ...
            this.parameterSolicitud = this.parameterSolicitud.setParameter({ idrol: 101, pagina: 1, busqueda: null, estado: 5, ordenpor: null, orden: null, _tab: 0 });
    ...
    private redirectPath(): void {
        this.parameterSolicitud.origen = 'ASESOR'
