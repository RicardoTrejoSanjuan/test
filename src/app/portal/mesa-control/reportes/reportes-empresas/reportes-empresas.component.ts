...
@Component({
    ...
    templateUrl: 'reportes-empresas.component.html',
    styleUrls: [
...
export class MesaControlReportesEmpresas extends ClassGenerica implements AfterViewInit {
