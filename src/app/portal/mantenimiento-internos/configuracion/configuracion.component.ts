...
export class ConfiguracionMIComponent extends ClassGenerica implements AfterViewInit {
        ...
        private Filtrarips(_str: string): void {
            ...
            //Save Item
                ...
                public mostrarDetalleModal(ips: any): void {
                  // Update Item
                        ...
                        public mostrarListaModal(ips: any): void {
                            // Update Item
